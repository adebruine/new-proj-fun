...
**TKTK: Describe new-proj-fun here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/new_proj_fun/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|new-proj-fun|tweet|`location`||
|new-proj-fun|facebook|`location`||
|new-proj-fun|email|`location`||
|new-proj-fun|new-comment||
|new-proj-fun|open-share-discuss||
|new-proj-fun|close-share-discuss||
|new-proj-fun|summary-copied||
|new-proj-fun|featured-tweet-action|`action`|
|new-proj-fun|featured-facebook-action|`action`|
